...
// Source: github.com/yukithm/grpc-example/helloworld (interfaces: GreeterClient)
...
func (m *MockGreeterClient) SayHelloAgain(arg0 context.Context, arg1 *helloworld.HelloRequest, arg2 ...grpc.CallOption) (*helloworld.HelloReply, error) {
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
